...
namespace StudentPortal.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LasttName,Password")] LecturersModel lecturers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LasttName,Password")] LecturersModel lecturers)
        {
            if (id != lecturers.Id)
            {
                return NotFound();
